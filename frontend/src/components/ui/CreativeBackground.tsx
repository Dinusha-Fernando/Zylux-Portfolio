...
export function CreativeBackground({
  ...
  return (
    <div className={cn("absolute inset-0 z-0 pointer-events-none overflow-hidden select-none", className)}>
      ...
      {/* Dark Theme High-Resolution Creative Artwork */}
      <Image
        src={darkImgSrc}
      ...
      {showVignette && (
        <>
          {/* Dark Mode Vignette & Edge Fades */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_transparent_20%,_#0B0A0F_85%)] dark-only-bg" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0B0A0F] via-transparent to-[#0B0A0F]/85 dark-only-bg" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0B0A0F]/85 via-transparent to-[#0B0A0F]/85 dark-only-bg" />
      ...
      {/* Dark Mode Glow Orbs */}
      <div className="absolute -top-24 left-1/4 w-96 h-96 bg-[#FF4F9A]/12 rounded-full blur-[140px] pointer-events-none dark-only-bg" />
      <div className="absolute top-1/3 -right-20 w-80 h-80 bg-[#FF8A45]/10 rounded-full blur-[120px] pointer-events-none dark-only-bg" />
